  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <p className="font-normal text-sm">
        <span className="text-base font-medium"> Category: </span>{categoryName || "Spring collection, Streetwear, Women"} <span className="text-base font-medium">
           Restaurant: </span>{ brandName || "Spring collection, Streetwear, Women"}
      </p>
    </div>
  );
};
